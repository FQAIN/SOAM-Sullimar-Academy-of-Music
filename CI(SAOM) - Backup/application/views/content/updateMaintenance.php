        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/Maintenances/commitMaintenanceUpdate'); ?>" >
                            <h2>Update Maintenance Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Maintenances/index/" class="back"><-Back to Maintenance Listings</a></p>

                            <?php
                            foreach ($maintenance->result_array() as $item) {	
                                echo
                                "
                                            <input type='hidden' name='maintenanceID' value='" . $item['maintenanceID'] . "'/>
                                                
                                            <p><strong>Instrument ID:</strong><br/>
                                            <input type='text' name='instrumentID' value='" . $item['instrumentID'] . "' id='special'/>
                            ...
                            ?>
                            <br>
                            <p><input type="submit" name="submit" value="Update Maintenance"></p>
                            <br>
                        </form>
                    </div>
                </section>
