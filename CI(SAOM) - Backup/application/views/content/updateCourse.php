        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/Courses/commitCourseUpdate'); ?>" >
                            <h2>Update Event Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Courses/index/" class="back"><-Back to Course Listings</a></p>

                            <?php
                            foreach ($course->result_array() as $item) {
                                echo
                                "
                                            <input type='hidden' name='coursesID' value='" . $item['coursesID'] . "'/>
                                                
                                            <p><strong>Course Name:</strong><br/>
                                            <input type='text' name='courseName' value='" . $item['courseName'] . "' id='special'/>
                                            
                                            <p><strong>Description:</strong><br/>
                                            <input type='text' name='description' value='" . $item['description'] . "' id='special'></p>
                                            
                                            <p><strong>Level:</strong><br/>
                                            <input type='text' name='levels' value='" . $item['levels'] . "' id='special'></p>
                                                                                                                              
                                            <p><strong>Number Of Years:</strong><br/>
                                            <input type='text' name='numberOfYears' value='" . $item['numberOfYears'] . "' id='special'></p>
                                                
                                            <p><strong>Group Category:</strong><br/>
                                            <input type='text' name='groupCategory' value='" . $item['groupCategory'] . "' id='special'></p>
                                            
                                            <p><strong>Image:</strong><br/>
                                            <input type='text' name='image' value='" . $item['image'] . "' id='special'></p>
                                                
                                            <p><strong>Staff ID:</strong><br/>
                                            <input type='text' name='staffID' value='" . $item['staffID'] . "' id='special'></p>
                            ...
                            ?>
                            <br>
                            <p><input type="submit" name="submit" value="Update Course"></p>
                            <br>
                        </form>
                    </div>
                </section>
