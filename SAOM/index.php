                    ...
                    <div class="col-md-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                ...
                                <li><a href="#">Books</a>
                                    <ul class="sub-menu">
                                        <li><a href="#">Categories of Books</a>
                                            <ul class="sub-menu">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="banner-caption">
                        ...
                        <h2>Suillimar Academy of Music</h2>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <h2>Books that you might be intrested in</h2>
                    </div>
                </div> 
            </div> 
            <div class="owl-carousel owl-theme">
                <div class="item popular-item">
                    <div class="thumb">
                        <img src="img/9781628920437.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        ...
                        <h2>Have a passion for music why not go to an event</h2>
                    </div>
                </div> 
            </div> 
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="featured-item">
                        <div class="thumb">
                            <img src="img/audience-868074_1920.jpg" alt="">
