                ...
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" >
                            <h2>Process External Exam</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Pexams/index/" class="back"><-Back to Processed External Exams Listings</a></p>

                            <p><strong>Exam ID:</strong><br/>
                                <input type="text" name="examID" value="<?php echo set_value('examID'); ?>" placeholder="Exam ID" id="special"/>
                            ...
                            <br>
                            <p><input type="submit" name="submit" value="Process External Exam"></p>
                            <br>
                        </form>
                    </div>
                </section>
