    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="banner-caption">
                            ...
                            <h2>Add Event</h2>
                            <span>Add an Event to SAOM</span>
        ...
        <section class="" id="">
            <div class="container-fluid">
                ...
                <h1 class=""><strong>Update Students Results</strong></h1>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 has-feedback">
                                <input name="element2" class="form-control" type="text" placeholder="K007777777"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 has-feedback">
                                <input name="element2" class="form-control" type="text" placeholder="C079"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 has-feedback">
                                <input name="element2" class="form-control" type="text" placeholder="78.00"/>
                    ...
                    <div class="form-group">
                            <div class="col-md-offset-3 col-md-9">
                                ...
                                <button class="btn" id="btnSave">
                                    Save <span class="glyphicon glyphicon-cloud-upload"></span>
                                </button>
                            </div>
                        </div>
