        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/TeachersArea/commitTeachersAreaUpdate'); ?>" >
                            <h2>Update Teacher Item Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/TeachersArea/index/" class="back"><-Back to Staff Listings</a></p>

                            <?php
                            foreach ($teachersArea->result_array() as $item) {	
                                echo
                                "
                                            <input type='hidden' name='teachersAreaID' value='" . $item['teachersAreaID'] . "'/>
                                                
                                            <p><strong>Title:</strong><br/>
                                            <input type='text' name='title' value='" . $item['title'] . "' id='special'/>
