...
<section class="" id="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="firstName"
                                                               placeholder=" John Doe" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Staff Course</label>

                                                        <input class="form-control" type="text" name="firstName"
                                                               placeholder="Pianno" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <fieldset>
                                                            <label class="control-label">Staff Description</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="firstName"
                                                               placeholder="28" ng-model="me.firstName">
                                                    </div>
                                                     <div class="col-md-6">
                                                     ...
                                                     <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="firstName"
                                                               placeholder="Dublin" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <fieldset>
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            <div class="wrapper">
                <button type="button" class="btn" data-toggle="modal" data-target=".bd-example-modal-sm">Add New Staff</button>
                                ...
                                <div class="col-md-20" style="padding: 10px;"> 
                                    <div class="left-content">
                                        <div class="row">
                                            <div class="col-md-20">
                                                <div class="section-heading">
                                                    <span>Add New Staff Details</span>
                                                </div>
                                            </div>
                                            <div class="col-md-20">
                                                <label class="control-label">Staff Name</label>
                                            ...
                                            <div class="col-md-20">
                                                <label class="control-label">Staff Modules</label>
