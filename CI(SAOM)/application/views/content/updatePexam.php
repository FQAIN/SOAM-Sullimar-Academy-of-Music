        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/Pexams/commitPexamUpdate'); ?>" >
                            <h2>Update Pexam Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Pexams/index/" class="back"><-Back to Pexam Listings</a></p>

                            <?php
                            foreach ($pexam->result_array() as $item) {	
                                echo
                                "
                                            <input type='hidden' name='pexamID' value='" . $item['pexamID'] . "'/>
                                                
                                            <p><strong>Exam ID:</strong><br/>
                                            <input type='text' name='examID' value='" . $item['examID'] . "' id='special'/>
                            ...
                            ?>
                            <br>
                            <p><input type="submit" name="submit" value="Update Pexam"></p>
                            <br>
                        </form>
                    </div>
                </section>
