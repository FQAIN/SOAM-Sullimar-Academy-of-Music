        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/Staffs/commitStaffUpdate'); ?>" >
                            <h2>Update Staff Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Staffs/index/" class="back"><-Back to Staff Listings</a></p>

                            <?php
                            foreach ($staff->result_array() as $item) {	
                                echo
                                "
                                            <input type='hidden' name='staffID' value='" . $item['staffID'] . "'/>
                                                
                                            <p><strong>First Name:</strong><br/>
                                            <input type='text' name='fName' value='" . $item['fName'] . "' id='special'/>
                                            
                                            <p><strong>Last Name:</strong><br/>
                                            <input type='text' name='lName' value='" . $item['lName'] . "' id='special'></p>
                                            
                                            <p><strong>Role:</strong><br/>
                                            <input type='text' name='role' value='" . $item['role'] . "' id='special'></p>
                                                                                                                              
                                            <p><strong>Date of Birth:</strong><br/>
                                            <input type='date' name='dob' value='" . $item['dob'] . "' id='special'></p>
