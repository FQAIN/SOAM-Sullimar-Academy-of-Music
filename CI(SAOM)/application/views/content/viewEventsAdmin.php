                                            ...
                                            <div class="left-content">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="firstName" placeholder="Music Night+" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Category</label>
                                                        <input class="form-control" type="text" name="firstName" placeholder="music " ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <fieldset>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="text" name="firstName" placeholder="Limerick" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Time</label>
                                                        <input class="form-control" type="time" name="firstName" placeholder="Timing" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Host/Speaker</label>
                                                        <input class="form-control" type="text" name="firstName" placeholder="Joe Moloney" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="control-label">Date</label>
                                                        <input class="form-control" type="date" name="firstName" placeholder="" ng-model="me.firstName">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <fieldset>
                                ...
                                <div class="col-md-20" style="padding: 10px;"> 
                                    <div class="left-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-20">
                                                <label class="control-label">Time</label>
                                                <input class="form-control" type="time" name="firstName" placeholder=" " ng-model="me.firstName">
                                            </div>
                                            <div class="col-md-20">
                                                <label class="control-label">Date</label>
