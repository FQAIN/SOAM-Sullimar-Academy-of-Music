     ...
     <section id="survey-form">
        ...
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" >
            ...
            <p><strong>Name:</strong><br/>
                <input type="text" name="name" value="<?php echo set_value('name'); ?>" placeholder="Enter Name" id="special"/>
      <?php echo form_error('name'); ?>
            <p><strong>Description:</strong><br/>
                <input type="text" name="description" value="<?php echo set_value('description'); ?>"  placeholder="Enter Last Name" id="special"></p>
              <?php echo form_error('description'); ?>
            <p><strong>Date of Event:</strong><br/>
                <input type="date" name="dateOfEvent" value="<?php echo set_value('dateOfEvent'); ?>"  placeholder="Enter Password" id="special"></p>
    <?php echo form_error('dateOfEvent'); ?>
            <p><strong>Price:</strong><br/>
                <input type="text" name="price" value="<?php echo set_value('price'); ?>"  placeholder="Enter Phone" id="special"></p>
             <?php echo form_error('price'); ?>
            <p><strong>Location:</strong><br/>
                <input type="text" name="location" value="<?php echo set_value('location'); ?>"  placeholder="Enter Email" id="special"></p>
               <?php echo form_error('location'); ?>
            <p><strong>Image:</strong><br/>
                <input type="text" name="Image" value="<?php echo set_value('Image'); ?>"  placeholder="Enter Address Line 1" id="special"></p>
