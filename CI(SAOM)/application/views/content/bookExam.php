...
<section class="" id="">
    ...
    <div class="panel-body">
        <?php foreach($ExamDetails->result_array() as $cd) : ?>
        <!--<form name="template" class="form-horizontal" <?php echo site_url('Exams/applyForExam/' . $cd['examID']); ?>" method="POST">-->
        <form name="template" class="form-horizontal" action="<?php echo site_url('Exams/applyForExam'); ?>" method="POST">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input name="ExamName" class="form-control" type="text" value="<?php echo $cd['examName']; ?>" readonly/>
                        <input type="hidden" name="examID" value="<?php echo $cd['examID']; ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input name="examYear" class="form-control input-sm" type="text" value="<?php echo $cd['examYear']; ?>" readonly/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">Category:</label>
                    <div class="col-md-9">
                        <input name="category" class="form-control input-sm" type="text" value="<?php echo $cd['Category']; ?>" readonly/>
                    </div>
                </div>
                <div class="form-group">
