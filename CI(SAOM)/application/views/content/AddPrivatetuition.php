<html>
    <head>
        <title>Add a Privatetuition</title>
        <style>
                ...
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" >
                            <h2>Add Private Tuition Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Privatetuitions/index/" class="back"><-Back to Private Tuition Listings</a></p>

                            <p><strong>Room:</strong><br/>
                                <input type="text" name="room" value="<?php echo set_value('room'); ?>" placeholder="Room" id="special"/>
