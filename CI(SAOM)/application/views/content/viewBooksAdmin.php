...
<section class="" id="">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="section-heading">
                                                            ...
                                                            <h2>Update Record for Best Vocals</h2>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
    ...
    <div class="container">
        <div class="col-md-10 col-md-offset-1">
            <div class="wrapper">
                <button type="button" class="btn" data-toggle="modal" data-target=".bd-example-modal-sm">Add New Book</button>
                                ...
                                <div class="col-md-20" style="padding: 10px;"> 
                                    <div class="left-content">
                                        <div class="row">
                                            <div class="col-md-20">
                                                <div class="section-heading">
                                                    <span>Add New Book Details</span>
                                                </div>
                                            </div>
                                            <div class="col-md-20">
                                                <label class="control-label">Book Name</label>
