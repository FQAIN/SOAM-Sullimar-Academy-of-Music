...
<section class="" id="">
    <div class="container-fluid">
        <h1 class=""><strong>Process External Exams</strong></h1>
    </div>
    <div class="panel-body">
        <form name="template" class="form-horizontal">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-3 control-label">Exainer Name</label>
                    <div class="col-md-9">
                        <select name="element1" id="element1" class="form-control" type="text">
                            <option value="item1">Tom</option>
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label">Exam Center</label>
                    <div class="col-md-9">
                        <select name="element1" id="element1" class="form-control" type="text">
                            <option value="item1">Limerick</option>
                            <option value="item2">Item 2</option>
                            <option value="item3">Item 3</option>
                        </select>
                        <span class="help-block">Select an option</span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input name="element3" class="form-control" type="date" />
                    </div>
                </div>
                <div class="form-group">
