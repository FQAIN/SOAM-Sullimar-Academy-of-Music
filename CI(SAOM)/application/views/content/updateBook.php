        ...
        <body>
            <div id="form">
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo base_url('index.php/Books/commitBookUpdate'); ?>" >
                            <h2>Update Book Details</h2>
                            <p><a href="<?php echo base_url(); ?>index.php/Books/index/" class="back"><-Back to Book Listings</a></p>

                            <?php 
                            foreach ($book->result_array() as $item) 
                                {
                                    echo 
                                        "
                                            <input type='hidden' name='booksID' value='" . $item['booksID'] . "'/>
                                                
                                            <p><strong>Book Name:</strong><br/>
                                            <input type='text' name='bookName' value='" . $item['bookName'] . "' id='special'/>
                                            
                                            <p><strong>Description:</strong><br/>
                                            <input type='text' name='description' value='" . $item['description'] . "' id='special'></p>
                                            
                                            <p><strong>Author:</strong><br/>
                                            <input type='text' name='author' value='" . $item['author'] . "' id='special'></p>
                                            
                                            <p><strong>Year Published:</strong><br/>
                                            <input type='text' name='yearPublished' value='" . $item['yearPublished'] . "' id='special'></p>
                                            
                                            <p><strong>Price:</strong><br/>
                                            <input type='text' name='price' value='" . $item['price'] . "' id='special'></p>
                                            
                                            <p><strong>Category:</strong><br/>
                                            <input type='text' name='category' value='" . $item['category'] . "' id='special'></p>
                                            
                                            <p><strong>ISBN:</strong><br/>
                                            <input type='text' name='ISBN' value='" . $item['ISBN'] . "' id='special'></p>
                                            
                                            <p><strong>In Stock:</strong><br/>
                                            <input type='text' name='inStock' value='" . $item['inStock'] . "' id='special'></p>
                                            
                                            <p><strong>Quantity:</strong><br/>
                                            <input type='text' name='qty' value='" . $item['qty'] . "' id='special'></p>
