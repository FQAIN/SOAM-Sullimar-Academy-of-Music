                ...
                <section id="survey-form">
                    <div class="form-gp">
                        <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" >
                            ...
                            <p><a href="<?php echo base_url(); ?>index.php/Exams/index/" class="back"><-Back to Exam Listings</a></p>

                            <p><strong>Exam name:</strong><br/>
                                <input type="text" name="examName" value="<?php echo set_value('examName'); ?>" placeholder="Exam Name" id="special"/></p>
                            <?php echo form_error('examName'); ?>

                            <p><strong>Date Of Exam:</strong><br/>
                                <input type="date" name="dateOfExam" value="<?php echo set_value('dateOfExam'); ?>"  placeholder="Date of Exam" id="special"></p>
                            <?php echo form_error('dateOfExam'); ?>
                            ...
                            <p><strong>Exam Category:</strong><br/>
                                <input type="text" name="examCategory" value="<?php echo set_value('examCategory'); ?>"  placeholder="Exam Category" id="special"></p>
                            <?php echo form_error('examCategory'); ?>

                            <p><strong>Exam Time:</strong><br/>
                                <input type="time" name="examTime" value="<?php echo set_value('examTime'); ?>"  placeholder="Exam Time" id="special"></p>
                            ...
                            <p><strong>Exam Description:</strong><br/>
                                <input type="text" name="examDescription" value="<?php echo set_value('examDescription'); ?>"  placeholder="Exam Description" id="special"></p>
                                <?php echo form_error('examDescription'); ?>
